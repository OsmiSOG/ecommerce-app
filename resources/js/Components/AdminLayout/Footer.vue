<template>
    <footer class="mt-auto p-4 my-6 mx-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8 dark:bg-gray-800">
    ...
    <p class="my-10 text-sm text-center text-gray-500">
        &copy; now <a href="#" class="hover:underline" target="_blank">OsmiSOG.com</a>. All rights reserved.
    </p>
</template>
