...
const themeToggleHandle = () => {
    ...
    if (!localStorage.theme) {
        themeMode.value = localStorage.theme = 'dark'
        document.documentElement.classList.add('dark')
    } else if (localStorage.theme === 'dark') {
        themeMode.value = localStorage.theme = 'light'
...
onMounted(() => {
    themeMode.value = localStorage.theme
});
    ...
    <nav class="fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            ...
            <div class="flex items-center justify-start">
                ...
                <Link :href="route('home')" class="flex ml-2 md:mr-24 items-center">
                    <span class="text-justify self-center text-xl font-semibold sm:text-2xl dark:text-white">El Desarrollador Sr</span>
                </Link>
            </div>
            <div class="flex items-center">
                ...
                <button id="theme-toggle" data-tooltip-target="tooltip-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5" @click.prevent="themeToggleHandle">
                    <svg v-if="themeMode === 'dark'" id="theme-toggle-dark-icon" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
                    <svg v-if="themeMode === 'light'" id="theme-toggle-light-icon" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
                    <i v-if="!themeMode" class="fa-solid fa-circle-half-stroke"></i>
                </button>
                ...
                <div class="flex items-center ml-3">
                    ...
                    <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                        ...
                        <img class="w-8 h-8 rounded-full" :src="`https://ui-avatars.com/api/?name=${$page.props.auth.user.name}`" alt="user photo">
                    </button>
                    </div>
                    <!-- Dropdown menu -->
                    ...
                    <ul class="py-1" role="none">
                        <li>
                            <Link href="/" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Marketplace</Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link :href="route('logout')" method="post" as="button" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem"> Sign Out </Link>
                        </li>
                    </ul>
                    </div>
                </div>
