...
const tableFields = [
    { label: 'Product name', field: 'name', sort: true},
    { label: 'Brand', field: 'brand', sort: true},
    { label: 'Model', field: 'model', sort: true},
    { label: 'reference', field: 'reference', sort: false},
...
const searchQuery = () => {
    router.get(route('sell.product.index', {
        _query: {
        ...
        <div class="p-12">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <nav class="flex items-center justify-between pt-4" aria-label="Table navigation">
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">Showing <span class="font-semibold text-gray-900 dark:text-white">{{products.from}}-{{products.to}}</span> of <span class="font-semibold text-gray-900 dark:text-white">{{products.total}}</span></span>
                    <ul class="inline-flex -space-x-px text-sm h-8">
                        ...
                        <li>
                            <Link :href="products.last_page_url" class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 rounded-r-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                &raquo;&raquo;
                            </Link>
                        </li>
                    </ul>
