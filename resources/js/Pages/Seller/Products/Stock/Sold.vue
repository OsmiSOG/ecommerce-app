...
const tableFields = [
    ...
    { label: 'Price', field: 'sold_price', sort: true},
    { label: 'Sold At', field: 'sold_at', sort: true},
    { label: 'Buyer email', field: 'id', sort: false},
    { label: 'Buyer name', field: 'id', sort: false},
    { label: 'Buyer phone', field: 'id', sort: false},
    { label: 'Delivery to', field: 'id', sort: false},
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" v-for="productStock in stock.data" :key="productStock.id">
                            ...
                            <td class="px-6 py-4">
                                {{ NumberFormat(productStock.sold_price) }}
                            </td>
                            <td class="px-6 py-4">
                                {{ productStock.sold_at }}
                            </td>
                            <td class="px-6 py-4">
                                {{ productStock.sale.buyer.email }}
                            </td>
                            <td class="px-6 py-4">
                                {{ productStock.sale.delivery_information.name }}
                            </td>
                            <td class="px-6 py-4">
                                {{ productStock.sale.delivery_information.number_phone }}
                            </td>
                            <td class="px-6 py-4">
                                {{ productStock.sale.delivery_information.country }} /
                                {{ productStock.sale.delivery_information.city }} /
                                {{ productStock.sale.delivery_information.address }} /
                                {{ productStock.sale.delivery_information.details }} /
                            </td>
                            <td class="px-6 py-4">
