...
const navigation = [
  ...
  { name: 'Portal', href: '/dashboard', current: false },
]
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                <div class="text-center">
                    ...
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="#" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">I wanna sell</a>
                        <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Let's to buy <span aria-hidden="true">→</span></a>
                    </div>
                </div>
            </div>
