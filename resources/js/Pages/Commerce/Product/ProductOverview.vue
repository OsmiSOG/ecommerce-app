            ...
            <div class="pt-6">
                ...
                <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
                    ...
                    <div class="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <form class="mt-10">
                            <Link :href="route('cart.add', product.id)" method="post" as="button" @success="Swal.fire('Added', 'added to bag', 'success')" preserve-scroll class="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                Add to bag
                            </Link>
                        </form>
                    </div>
